...
>>>>>>> cb73a2ce945f8961b47b647a545d26c93decf02c
        ...
        <ModalContent className="w-full">
          ...
          <div className="flex gap-4 p-4 h-[100vh]">
            ...
            <div className="w-1/6 border-r border-zinc-700 pr-2 overflow-y-auto">
              <h4 className="text-white font-semibold text-sm mb-2">Students</h4>
                ...
                <>
                  ...
                  <div className="bg-black rounded-md border border-zinc-700 p-2 mb-4">
                    <CodeEditor
                      ...
                      initialLockedLines={[]}
                      role="viewer"
                      starterCode={selectedStudentCode.code || "# No code submitted"}
                      height="600px"
                      disableMenu={true}
                      ...
                      <div className="mt-2 flex justify-end">
                        <Button
                          ...
                          onPress={() => {
                            setComments((prev) => ({
                              ...prev,
                              [activeLine]: [...(prev[activeLine] || []), newComment],
                            }));
                            setNewComment("");
                            setActiveLine(null);
                          }}
